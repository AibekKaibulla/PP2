...
def handle_keydown(event, color, flags):
    match event.key:
        ...
        case pygame.K_q:
            flags.update({'isMouseDown': False, 'drawRect': True, 'drawCircle': False, 
             'drawSquare': False, 'drawRightTriangle': False,
             'drawEqualTriangle': False, 'drawRhombus': False, 
             'eraser': False}) # Enable rectangle drawing mode
        case pygame.K_w:
            flags.update({'isMouseDown': False, 'drawRect': False, 'drawCircle': True, 'drawSquare': False, 'drawRightTriangle': False,
             'drawEqualTriangle': False, 'drawRhombus': False, 
             'eraser': False}) # Enable circle drawing mode
        case pygame.K_e:
            flags.update({'isMouseDown': False, 'drawRect': False, 'drawCircle': False, 'drawSquare': False, 'drawRightTriangle': False,
             'drawEqualTriangle': False, 'drawRhombus': False, 
             'eraser': True}) # Enable eraser mode
        case pygame.K_r:
            flags.update({'isMouseDown': False, 'drawRect': False, 'drawCircle': False, 'drawSquare': False, 'drawRightTriangle': True,
             'drawEqualTriangle': False, 'drawRhombus': False, 
             'eraser': False}) # Enable Right Triangle drawing mode
        case pygame.K_t:
            flags.update({'isMouseDown': False, 'drawRect': False, 'drawCircle': False, 'drawSquare': False, 'drawRightTriangle': False,
             'drawEqualTriangle': True, 'drawRhombus': False, 
             'eraser': False}) # Enable Equal Triangle drawing mode
        case pygame.K_y:
            flags.update({'isMouseDown': False, 'drawRect': False, 'drawCircle': False, 'drawSquare': False, 'drawRightTriangle': False,
             'drawEqualTriangle': False, 'drawRhombus': True, 
             'eraser': False}) # Enable Rhombus drawing mode
        case pygame.K_z:
            flags.update({'isMouseDown': False, 'drawRect': False, 'drawCircle': False, 'drawSquare': True, 'drawRightTriangle': False,
             'drawEqualTriangle': False, 'drawRhombus': False, 
             'eraser': False}) # Enable Square drawing mode
        case _:
            pass
    return color, flags
...
def draw_shapes(screen, layer, color, flags):
    if flags['isMouseDown'] and all(flags[k] != -1 for k in ['X', 'Y', 'cur_X', 'cur_Y']):
        ...
        elif flags['drawCircle']: 
            screen.blit(layer, (0, 0))
            rect = calculate_rect(flags['X'], flags['Y'], flags['cur_X'], flags['cur_Y'])
            pygame.draw.ellipse(screen, color, rect, 1) # Draw ellipse
        elif flags['drawSquare']:
            screen.blit(layer, (0, 0)) 
            rect = calculate_rect(flags['X'], flags['Y'], flags['cur_X'], flags['cur_Y'])
            pygame.draw.rect(screen, color, rect, 1)
        elif flags['drawRightTriangle']:
            screen.blit(layer, (0, 0))
            rect = calculate_rect(flags['X'], flags['Y'], flags['cur_X'], flags['cur_Y'])
            pygame.draw.polygon(screen, color,[ [flags['X'], flags['Y']], [flags['X'], flags['cur_Y']], [flags['X'], flags['cur_Y']] ], 1 )
...
def main():
    ...
    color = (0, 0, 0)
    flags = {'isMouseDown': False, 'drawRect': True, 'drawCircle': False, 'drawSquare': False, 'drawRightTriangle': False,
             'drawEqualTriangle': False, 'drawRhombus': False, 
             'eraser': False, 'X': -1, 'Y': -1, 'cur_X': -1, 'cur_Y': -1}
